...
var arr = ["rgb(204, 207, 3)","rgb(204, 10, 10)","rgb(6, 66, 207)","gray","rgb(16, 15, 15)"]
...
document.querySelector("body").addEventListener("mousemove",function(dets){
    if(dets.target.className === "img"){
        ...
        document.querySelector("#"+dets.target.id).style.transform = "scale(1.05)";
       document.querySelector("body").style.backgroundColor = `${arr[ dets.target.id[3]-1]}`
}
})
